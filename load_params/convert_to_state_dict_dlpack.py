...
save_path = 'torch_weigts/af3.pth'
...
------------
evoformer转化后剩下的需要特殊处理的

### confidence_head q_projection_bias 4个

confidence_head.pairformer_stack.3.single_attention.q_projection_bias torch.Size([1, 16, 24])
diffuser/confidence_head/__layer_stack_no_per_layer/confidence_pairformer/single_attention_q_projection/bias
name aligned
shape not aligned, torch_shape [1, 16, 24] jax_shape [4, 16, 24]


### diffusion_head q_projection_bias 3个
diffusion_head.diffusion_atom_cross_att_decoder.atom_transformer_decoder.cross_att_blocks.2.cross_attention.q_projection_bias torch.Size([1, 4, 32])
diffuser/~/diffusion_head/diffusion_atom_transformer_decoder/__layer_stack_with_per_layer/diffusion_atom_transformer_decoderq_projection/bias
name aligned
shape not aligned, torch_shape [1, 4, 32] jax_shape [3, 4, 32]


### diffusion_head q_projection_bias 3个
diffusion_head.diffusion_atom_cross_att_encoder.atom_transformer_encoder.cross_att_blocks.2.cross_attention.q_projection_bias torch.Size([1, 4, 32])
diffuser/~/diffusion_head/diffusion_atom_transformer_encoder/__layer_stack_with_per_layer/diffusion_atom_transformer_encoderq_projection/bias
name aligned
shape not aligned, torch_shape [1, 4, 32] jax_shape [3, 4, 32]

### diffusion_head q_projection_bias 6*4=24个

diffusion_head.transformer.super_transformer_blocks.5.3.self_attention.q_projection_bias torch.Size([1, 16, 48])
diffuser/~/diffusion_head/transformer/__layer_stack_with_per_layer/__layer_stack_with_per_layer/transformerq_projection/bias
name aligned
shape not aligned, torch_shape [1, 16, 48] jax_shape [6, 4, 16, 48]
